...
{
    int GetYearRequestsCountForUserInHoursByRequestType(int userId, RequestType requestType);
    ...
    List<RequestModelDto> GetAllAcceptedRequestsMonthly(DateTime from, DateTime to);
}